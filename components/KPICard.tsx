...
const KPICard: React.FC<Props> = ({ title, value, variant = "light", trend, subValue, info }) => {
  ...
  return (
    ...
    >
      {/* Info icon pinned top-right (does NOT affect layout) */}
      {info && (
      ...
      {/* Title (pad right so it never goes under the icon) */}
      <p
        className={`pr-10 text-[10px] font-bold uppercase tracking-[0.2em] ${
